    ...
    <section className="bg-[#000000] text-white py-16 px-6 md:px-12 lg:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div>
          ...
          {/* RED HIGHLIGHT LINE */}
          <div className="w-20 h-[3px] bg-[#D70C09] mb-6"></div>
          ...
          <p className="text-[#868386] leading-relaxed mb-8">
          ...
          <button className="bg-[#D70C09] hover:bg-[#868386] text-white font-medium py-3 px-8 rounded-sm transition">
            Contact Us
          </button>
        </div>
        ...
        <div className="flex flex-row gap-4 w-full">
          ...
          {/* SILVER DIVIDER */}
          <div className="w-[2px] bg-[#C0C0C0]/40"></div>
