  ...
  const solutions = [
    {
      ...
      icon: (
        <CircleAlert className="w-7 h-7 text-[#EF4444] drop-shadow-[0_0_6px_#EF4444]" />
      ),
      items: [
    ...
    },
    {
      ...
      items: ["Identify faults", "Improve efficiency", "Reduce engine hesitation"],
    },
    {
      title: "AdBlue / SCR Assistance",
      icon: (
        <Gauge className="w-7 h-7 text-[#EF4444] drop-shadow-[0_0_6px_#EF4444]" />
      ),
      items: ["Fix system errors", "Improve NOx performance", "Prevent limp mode issues"],
    },
    {
      title: "ECU & Sensor Diagnostics",
      icon: (
        <Wrench className="w-7 h-7 text-[#EF4444] drop-shadow-[0_0_6px_#EF4444]" />
      ),
      items: ["Advanced fault tracing", "Performance-focused solutions", "OEM-level tools"],
    },
  ];
